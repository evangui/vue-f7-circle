	...
	<div class="page">
		...
		<div class="page-content hide-navbar-on-scroll infinite-scroll-content" @infinite="loadMore">
			<div style="background-color: #ffffff;">
				<div class="hnp-title" style="padding: 0.4rem 0.4rem 0.8rem;font-size: 26px;font-weight: 600;">
					<div style="height: 12vw;margin:1.2rem 0 0;position: relative;">
						<span style="position:absolute; margin-left:1rem;top:2vw">我的生活贴</span>
					</div>
				</div>
			</div>
			...
			<div class="content-list" style="margin: 1.6rem 1rem;padding: 1rem; border-radius: 8px;background-color: #ffffff;">
				...
				<div v-for="item in themeList" class="list-item">
					<div class="item-head">
						...
						<div style="float: right;overflow: hidden;margin: 0 1rem;">
					...
					<div @click="$redirect('/circletheme-detail/id/' + item.theme_id + '/')" class="item-body">
						<img v-if="item.main_imgs" v-lazy="item.main_imgs[0]" class="avatar ">
	...
	export default {
		...
		methods: {
			...
			loadList: function(page) {
				...
				wap.getajax('api/user/circletheme/myList', data, function(res) {
